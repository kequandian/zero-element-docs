...
var _default = (url, platform) => {
  ...
  if (!repoUrl && url) {
    ...
    if (platform === 'gitlab') {
      ...
      let originalHost;
      repoUrl = (_hostedGit$fromUrl2 = _hostedGitInfo().default.fromUrl( // fake to gitlab to make hostedGit worked
      // refer: https://github.com/npm/hosted-git-info/pull/30#issuecomment-400074956
      url.replace(/([\w-]+\.)+[\w-]+/, str => {
        originalHost = str;
        return 'gitlab.com';
      }))) === null || _hostedGit$fromUrl2 === void 0 ? void 0 : (_hostedGit$fromUrl2$b = _hostedGit$fromUrl2.browse() // restore the original host
