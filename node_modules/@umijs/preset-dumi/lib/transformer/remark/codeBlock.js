...
function codeBlock() {
  return ast => {
    ...
    (0, _unistUtilVisit().default)(ast, 'code', node => {
      ...
      if ((_ctx$opts = _context.default.opts) === null || _ctx$opts === void 0 ? void 0 : _ctx$opts.resolve.previewLangs.includes(node.lang)) {
        const modifier = codeBlockModifierParser(node.meta); // extract frontmatters for embedded demo
