...
var _default = (source, fileAbsPath, type) => {
  ...
  .use(_remarkParse().default).use(debug('parse')).use(_remarkGfm().default).use(debug('gfm')) // remark plugins
  .use(_remarkFrontmatter().default).use(debug('frontmatter')).use(_remarkMath().default).use(debug('math')).use(_meta.default).use(debug('meta')).use(_codeBlock.default).use(debug('codeBlock')) // remark to rehype
  .use(_rehype.default).use(debug('rehype')) // rehype plugins
  .use(_rehypeKatex().default, {
    strict: false
  }).use(debug('katex')).use(_sourceCode.default).use(debug('sourceCode')).use(_raw.default).use(debug('raw')).use(_domWarn.default).use(debug('domWarn')).use(_rehypeRemoveComments().default, {
    removeConditional: true
  }).use(debug('comments')).use(_img.default).use(debug('img')).use(_code.default).use(debug('code')).use(_embed.default).use(debug('embed')).use(_api.default).use(debug('api')).use(_slug.default).use(debug('slug')).use(_rehypeAutolinkHeadings().default).use(debug('headings')).use(_link.default).use(debug('link')).use(_previewer.default).use(debug('previewer')).use(_isolation.default).use(debug('isolation')).data('fileAbsPath', fileAbsPath).data('outputType', type); // apply compiler via type
