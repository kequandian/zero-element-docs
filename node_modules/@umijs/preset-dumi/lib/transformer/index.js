...
var _default = {
  ...
  markdown(raw, fileAbsPath, {
    ...
    // use cache first
    const result = fileAbsPath && !noCache && cachers.markdown.get(fileAbsPath) || (0, _remark.default)(raw, fileAbsPath, type); // save cache for the content which has real path
  ...
  code(raw) {
    ...
    return {
      content,
      meta: (0, _yaml.default)(frontmatter)
    };
  }
