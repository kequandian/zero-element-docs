...
function getFirstMenuInNav(childRoutes, customMenus) {
  var _customMenus$0$childr;

  let firstMenuInNav;
  const firstMenuItem = customMenus === null || customMenus === void 0 ? void 0 : (_customMenus$0$childr = customMenus[0].children) === null || _customMenus$0$childr === void 0 ? void 0 : _customMenus$0$childr[0]; // find first if user configured the first menu item for current nav
  ...
  if (typeof firstMenuItem === 'string') {
    ...
    firstMenuInNav = childRoutes.sort(_getMenuFromRoutes.menuSorter)[0];
  }
  ...
  routes.forEach(route => {
    ...
    if (((_route$meta$nav = route.meta.nav) === null || _route$meta$nav === void 0 ? void 0 : _route$meta$nav.path) && !redirects[route.meta.nav.path] && !routes.some(item => item.path === route.meta.nav.path)) {
      ...
      redirects[path] = {
        ...
        exact: true,
        redirect: getFirstMenuInNav(validRoutes.concat(validGroups), (_this$options$menus = this.options.menus) === null || _this$options$menus === void 0 ? void 0 : _this$options$menus[path]).path
      };
