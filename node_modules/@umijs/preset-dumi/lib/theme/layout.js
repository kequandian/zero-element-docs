...
var OuterLayout = function OuterLayout(props) {
  ...
  var base = useCurrentBase(locale, _config.default.locales, route); // scroll to anchor if hash exists

  (0, _react.useEffect)(function () {
    if (location.hash) {
      _AnchorLink.default.scrollToAnchor(decodeURIComponent(location.hash.slice(1)));
    }
  }, []);
